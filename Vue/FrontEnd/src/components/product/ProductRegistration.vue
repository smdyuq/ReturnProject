  ...
  <div class="saleWrapper">
    <div class="saleWrap">
      <div class="infoArticle">
        <span style="font-size: x-large">기본정보</span
        ><span style="color: red; margin-left: 20px">*필수항목</span>
      </div>
      ...
      <div class="infoTitle">
        <span class="basicInfo"
          >상품이미지<span class="sectionSign">*</span></span
        >
        <!-- <div>
      ...
      <div style="">
        <div class="infoTitle">
          <span class="basicInfo"
            >카테고리<span class="sectionSign">*</span></span
          >
              ...
              <div>
                <div>
                  <input
                    ...
                    :id="item.key"
                    name="category"
                    v-model="userProduct.salesCategory"
                    value="가전"
                  /><label :for="item.key">가전</label>
                </div>
                <div>
                  <input
                    type="radio"
      ...
      <div class="infoTitle">
        <span class="basicInfo"
          >거래지역<span class="sectionSign">*</span>
        </span>
        ...
        <div class="infoContent">
          <input
            ...
            v-model="userProduct.salesAddress"
          />
        </div>
      </div>
      ...
      <div class="infoTitle">
        <span class="basicInfo"
          >상품상태<span class="sectionSign">*</span></span
        >
        <div>
          <div>
            <input
              ...
              id="ProductStatus1"
              name="ProductStatus"
              v-model="userProduct.salesCondition"
              value="새상품(미사용)"
            /><label for="ProductStatus1">새 상품(미사용)</label>
          </div>
          <div>
            <input
              type="radio"
              ...
              v-model="userProduct.salesCondition"
              value="사용감 없음"
            /><label for="ProductStatus2">사용감 없음</label>
          </div>
          <div>
            <input
              type="radio"
              ...
              v-model="userProduct.salesCondition"
              value="사용감 적음"
            /><label for="ProductStatus3">사용감 적음</label>
          </div>
          <div>
            <input
              type="radio"
              ...
              v-model="userProduct.salesCondition"
              value="사용감 많음"
            /><label for="ProductStatus4">사용감 많음</label>
          </div>
          <div>
            <input
              type="radio"
              ...
              v-model="userProduct.salesCondition"
              value="고장/파손 상품"
            /><label for="ProductStatus5">고장/파손 상품</label>
          </div>
        </div>
      </div>
      ...
      <div class="infoTitle">
        ...
        <div>
          <input type="number" v-model="userProduct.salesPrice" /><span
            >원</span
          >
        </div>
      </div>
      ...
      <div class="infoTitle">
        ...
        <div>
          <input type="number" v-model="userProduct.salesDelivery" /><span
            >원</span
          >
        </div>
      </div>
      ...
      <div class="infoTitle">
        <span class="basicInfo"
          >상품설명<span class="sectionSign">*</span></span
        >
      ...
      <div class="infoTitle">
        ...
        <input type="number" id="count" v-model="userProduct.salesCount" /><span
          >개</span
        >
      </div>

      <div class="infoTitle">
        <span class="basicInfo" id="openChat"
          >오픈채팅<span class="sectionSign">*</span></span
        >
        <input
          type="text"
          placeholder="오픈채팅"
          id="openChatRink"
          v-model="userProduct.salesChatLink"
        />
      </div>
    </div>
    <div>
