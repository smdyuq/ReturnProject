  ...
  <div>
    ...
    <div>
      <div class="categoryBar">
        <router-link :to="{ path: '/CategoryAll' }" class="category"
          >전체</router-link
        >
        <router-link :to="{ path: '/CategoryCloth' }" class="category"
          >의류</router-link
        >
        <router-link :to="{ path: '/CategoryJewelry' }" class="category"
          >주얼리</router-link
        >
        <router-link :to="{ path: '/CategoryHomeAppliances' }" class="category"
          >가전</router-link
        >
        <router-link :to="{ path: '/CategoryFood' }" class="category"
          >식품</router-link
        >
      </div>
      <div>전체페이지</div>
      ...
      <div class="cardWrap" v-for="(item, index) in getUsers" :key="index">
        <div class="imgWrapper">
          <router-link :to="{ path: `/productDetail/${item.id}` }">
            <img
              :src="
                'http://192.168.0.4/resources/uploads/' + item.salesImageName
              "
