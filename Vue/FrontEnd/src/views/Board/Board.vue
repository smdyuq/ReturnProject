<template>
  ...
  <div class="boardTitle">
      <router-link to="/">
          <div><img class="leftArrow" src="../../assets/img/뒤로가기.png" style="width:22px; margin-bottom:25px;"></div>
      </router-link>
        ...
        <div class="comment-name">
          ...
          <div v-if="this.getMemberType === 0">
              <div class="comment-box">
                  ...
                  <textarea class="comment-input" id="com_content" cols="80" rows="2" v-model="ask_comment_content">
          </textarea>
