...
import infoDetail from '../views/4_infoDetail.vue'
import infoEditForm from '../views/4_infoEditForm.vue'
import calc from '../views/calc.vue'

const routes = [
    { path: '/', name: "home", component: home },
    { path: '/infoEditForm', name: "infoEditForm", component: infoEditForm },
